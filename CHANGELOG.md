...
## Unreleased
- support Pi `>=0.80.9 <=0.85.1` (tested here against exact `0.85.1`), preserving Pi 0.84+ nullable header-deletion markers at stream boundaries and omitting them from direct HTTP requests; compatibility-range reports were raised by @delmicio in #5, @hhe48203-ctrl in #6, and @ironerumi in #10
